...
import { obtenerConstantes } from '@/services/pocConstantsService.js';
...
const loginWithGoogle = async () =>
{
  try
  {
    ...
    //Prueba de concepto: llamada real al microservicio
    const googleIdToken = await result.user.getIdToken();
    const constantes = await obtenerConstantes(googleIdToken, 'admin', 'admin.cursoAcademicoActual');
